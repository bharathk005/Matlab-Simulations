...
Qo=0;L=0.5;D=0.5;m=0;
hold on;
r1=rand(1,3)*5;
r2=rand(1,3)*5;
r3=rand(1,3)*5;
r4=rand(1,3)*5;
scatter3(r1(1),r1(2),r1(3),1000,'r','fill');
scatter3(r2(1),r2(2),r2(3),1000,'r','fill');
scatter3(r3(1),r3(2),r3(3),1000,'r','fill');
scatter3(r4(1),r4(2),r4(3),1000,'r','fill');
whitebg('white');

cx=start;cy=start;cz=start;

while(cx<=endp(1) || cy<=endp(2) || cz<=endp(3))
x=cx+(rand(1,100)*0.5);
y=cy+(rand(1,100)*0.5);
z=cz+(rand(1,100)*0.5);
